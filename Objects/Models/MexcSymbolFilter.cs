...
/// Price filter
/// </summary>
public class MexcSymbolPriceFilter : MexcSymbolFilter
{
    /// <summary>
...
/// </summary>
public class MexcSymbolPercentPriceFilter : MexcSymbolFilter
{
    /// <summary>
...
/// Price percentage filter
/// </summary>
public class MexcSymbolPercentPriceBySideFilter : MexcSymbolFilter
{
    /// <summary>
...
/// Lot size filter
/// </summary>
public class MexcSymbolLotSizeFilter : MexcSymbolFilter
{
    /// <summary>
...
/// </summary>
public class MexcSymbolMarketLotSizeFilter : MexcSymbolFilter
{
    /// <summary>
    /// The minimal quantity of an order
    /// </summary>
...
/// Min notional filter
/// </summary>
public class MexcSymbolMinNotionalFilter : MexcSymbolFilter
{
    /// <summary>
...
/// Notional filter
/// </summary>
public class MexcSymbolNotionalFilter : MexcSymbolFilter
{
    /// <summary>
    /// The minimal total quote quantity of an order. This is calculated by Price * Quantity.
    /// </summary>
...
///Max orders filter
/// </summary>
public class MexcSymbolMaxOrdersFilter : MexcSymbolFilter
{
    /// <summary>
...
/// </summary>
public class MexcSymbolMaxAlgorithmicOrdersFilter : MexcSymbolFilter
{
    /// <summary>
...
/// </summary>
public class MexcSymbolIcebergPartsFilter : MexcSymbolFilter
{
    /// <summary>
...
/// Max position filter
/// </summary>
public class MexcSymbolMaxPositionFilter : MexcSymbolFilter
{
    /// <summary>
...
/// </summary>
public class MexcSymbolTrailingDeltaFilter : MexcSymbolFilter
{
    /// <summary>
...
/// </summary>
public class MexcMaxNumberOfIcebergOrdersFilter : MexcSymbolFilter
{
    /// <summary>
