...
public class MexcClientSpotApi : RestApiClient, IMexcClientSpotApi, ISpotClient
{
    ...
    internal static TimeSyncState TimeSyncState = new("Spot Api");

    internal new MexcClientOptions Options;
    ...
    internal MexcClientSpotApi(Log log, MexcClient baseClient, MexcClientOptions options)
    ...
    public override TimeSyncInfo GetTimeSyncInfo()
        => new(_log, Options.SpotApiOptions.AutoTimestamp, Options.SpotApiOptions.TimestampRecalculationInterval, TimeSyncState);
